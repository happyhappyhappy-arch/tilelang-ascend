    ...
    def run(self):
        ...
        for item in TVM_PREBUILD_ITEMS:
            ...
            if source_lib_file:
                ...
                # Only remove if it was a staging copy (e.g. in build_temp), not source tree (e.g. build/tilelangir)
                if os.path.abspath(source_lib_file).startswith(os.path.abspath(build_temp_dir)):
